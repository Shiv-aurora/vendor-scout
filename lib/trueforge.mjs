...
export function missionTurnPrompt(mission, { suppliers = [], activity = [] } = {}) {
  ...
  return [
    ...
    "Begin by reading the mission with vendor_scout_get_mission so you reconcile this prompt with current persisted state.",
    ...
    "When a real supplier reply arrives through an email/MCP transport, persist the exact reply and source reference with vendor_scout_record_supplier_reply before extracting or negotiating terms.",
    "Preserve evidence and provenance for factual supplier claims and communications. Do not invent supplier facts, messages, replies, quotes, or delivery state.",
