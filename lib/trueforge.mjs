...
export function missionTurnPrompt(mission, { suppliers = [], activity = [] } = {}) {
  ...
  return [
    ...
    "After candidates exist, call vendor_scout_qualify_suppliers so qualification is computed from the mission constraints and persisted evidence rather than improvised in prose.",
