...
const FIXTURE_SUPPLIERS = Object.freeze([
  {
    ...
    contactEmail: "sales@heliomotion.example",
    contactSourceReference: "controlled-fixture/contact/hm-ld20",
  ...
  },
  {
    ...
    contactEmail: "rfq@scanworks.example",
    contactSourceReference: "controlled-fixture/contact/sw-x2",
  ...
  },
  {
    ...
    contactEmail: "quotes@optipath.example",
    contactSourceReference: "controlled-fixture/contact/op-360",
  ...
  },
  {
    ...
    contactEmail: "sales@vectorsense.example",
    contactSourceReference: "controlled-fixture/contact/vs-l360",
  ...
  },
  {
    ...
    contactEmail: "rfq@ameriscan.example",
    contactSourceReference: "controlled-fixture/contact/as-r360",
...
function normalizeContact(candidate, reference, index) {
...
export function normalizeDiscoveredCandidate(candidate, mission, index = 0, sourceKind = "external-research") {
  ...
  const contact = normalizeContact(candidate, reference, index);
